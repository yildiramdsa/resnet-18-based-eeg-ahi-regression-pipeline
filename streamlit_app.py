...
def show_literature_review():
    ...
    st.markdown("""
    <span class="inline-badge">YOLOv5 Performance Analysis</span>. **YOLOv5** outperformed ResNet64 with balanced accuracy of 88.75%, macro precision of 0.8972, recall of 0.8875, and F1 of 0.8887. It maintained high precision on normal (0.99) and severe (0.94) classes, and strong recall on mild (0.96) and moderate (0.86) cases.
    """, unsafe_allow_html=True)
    col1, col2, col3 = st.columns(3)
    with col1:
    ...
    st.markdown("""
    <span class="inline-badge">YOLOv8 Performance Analysis</span>. **YOLOv8**, contrary to the original report, yielded a lower balanced accuracy of 72.25%, with macro precision of 0.7409, recall of 0.7225, and F1 score of 0.7247. Its performance was notably weaker on mild (precision = 0.64, recall = 0.72) and moderate (0.68/0.71) classes, although it retained good precision on normal cases (0.93).
    """, unsafe_allow_html=True)
    col1, col2, col3 = st.columns(3)
    with col1:
