...
def show_conclusion():
    ...
    st.markdown("""
    This study demonstrates the feasibility of automated <span class="inline-badge">sleep apnea severity assessment</span> using <span class="inline-badge">EEG spectrograms</span> and <span class="inline-badge">deep learning</span>, with our <span class="inline-badge">ResNet-18-based pipeline</span> achieving moderate performance (RMSE: <b>6.8 events/hour</b>, Pearson correlation: <b>0.76</b>) for scalable sleep apnea screening from standard EEG recordings. By leveraging a <span class="inline-badge">robust preprocessing pipeline</span> with stringent quality control for spectrogram generation, <span class="inline-badge">transfer learning</span> with a ResNet-18 architecture, and <span class="inline-badge">continuous AHI regression</span> for subject-level severity estimation, our approach provides clinically relevant, fine-grained predictions. The <span class="inline-badge">spectrogram-based approach</span> effectively captures spectral signatures associated with sleep apnea events, while <span class="inline-badge">subject-stratified validation</span> ensures realistic generalization to unseen individuals. Although systematic biases exist across the AHI spectrum, the modular and scalable design of our pipeline enables easy adaptation to diverse datasets and clinical settings, supporting future integration of multi-modal physiological signals and real-time clinical applications.
