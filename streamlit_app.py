...
def show_conclusion():
    ...
    with col2:
        ...
        Key contributions of this work include the development of a <span class="inline-badge">robust preprocessing pipeline with stringent quality control for EEG spectrogram generation</span>, the application of <span class="inline-badge">transfer learning using a ResNet-18 architecture optimized for medical imaging</span>, and the implementation of <span class="inline-badge">continuous AHI regression for precise, subject-level estimation of sleep apnea severity</span>. The modular and scalable design of the pipeline ensures adaptability to diverse datasets and facilitates integration into various clinical and research environments.
