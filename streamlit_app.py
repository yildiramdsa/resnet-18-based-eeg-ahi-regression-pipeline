...
def show_results():
    ...
    with col2:
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**Moderate to Severe AHI (15-35)**: Consistent underprediction tendency, with the model underestimating true AHI values by 5-8 events/hour. This pattern indicates the model may be conservative in predicting higher severity levels, potentially due to limited training examples in this range.
